...
@section('container')
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body p-4">
                        <div class="w-100 overflow-hidden text-center " height="250">
                            <img src="{{ asset('img/banten biyukaon.jpg') }}" alt="Logo Mewali"
                        ...
                        <p style="text-align: justify;">
                            Lorem ipsum dolor sit, amet consectetur adipisicing elit. Delectus officiis veniam quae, natus
                            cum numquam temporibus cumque nobis quisquam, dolore debitis possimus porro dolorem dicta
                            dolores officia iusto totam animi. Cupiditate tempore omnis repellendus explicabo laborum
                            distinctio ab a? Suscipit fuga ut animi consectetur odio, ipsam, porro fugit doloribus
                            distinctio commodi perferendis aut quisquam! Suscipit, corrupti quia voluptate cum doloremque
                            magni dolorem accusantium, aliquid placeat nam nostrum obcaecati quo aut maiores reiciendis
                            tempora labore architecto eaque beatae dolorum sed adipisci minima? Exercitationem, impedit.
                            Dolores at, corporis magni repellendus inventore eaque sunt sit facere in? Ab enim, sunt eveniet
                            repellat vitae itaque corrupti exercitationem quos blanditiis debitis. Tempora amet ab, sed
                            facere molestiae alias? Provident modi aperiam illum pariatur nulla qui cumque reiciendis
                            molestias nam ipsa veritatis esse, voluptate sint hic, enim earum! Odio dolores numquam iste
                            maxime repellendus eveniet illum iure ex quas labore itaque dolorum ab molestiae esse, sint
                            tempora natus, quam accusamus. Minus accusantium, accusamus dolorem autem ipsa dignissimos sequi
                            perferendis, quam blanditiis omnis aspernatur excepturi praesentium sed quis ipsam doloremque!
                            Ad deleniti rem et natus quae! Quis odio dolor dolore accusantium voluptatum, ipsam soluta
                            quisquam officia officiis facere velit commodi incidunt sunt consequuntur mollitia maiores
                            asperiores. Fugit?
                        </p>
    ...
    <script>
        ...
        $('.btn-primary').on('click', function() {
            var cardData = $(this).data('card-data'); // Get data from data attribute
            $('#modal-content').text(cardData); // Set data in the modal
        });
    </script>
@endsection
